  ...
  return (
    <>
      <button
        ...
        aria-expanded={open}
        onClick={toggle}
        className={`inline-flex w-full items-center gap-1.5 rounded-full px-2.5 py-1.5 text-[13.5px] font-semibold ring-1 transition ${toneClasses[tone]}`}
      >
            ...
            {includeClear && (
              <li>
                <button
                  ...
                  className="flex w-full items-center gap-2 rounded-lg px-2.5 py-2 text-[13.5px] text-faint transition hover:bg-white/[0.07]"
                >
            ...
            {options.map((o) => (
              <li key={o.value}>
                <button
                  ...
                  className={`flex w-full items-center gap-2 rounded-lg px-2.5 py-2 text-[13.5px] font-medium transition hover:bg-white/[0.07] ${
